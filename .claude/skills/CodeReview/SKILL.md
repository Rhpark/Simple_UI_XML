---
name: CodeReview
description: Android code review for Android Library. Focuses on high-impact issues - naming conventions, memory leaks, UIState patterns, business logic placement, lifecycle management, and MVI/MVVM pattern violations. Use when reviewing Kotlin files, pull requests, or checking ViewModels, Activities, Fragments, UseCases, and Repositories.
allowed-tools: Read, Grep, Glob
---

# Android Code Review - Critical Issues Focus

Expert Android code reviewer for Android Library, focusing on CRITICAL and HIGH PRIORITY issues that impact app stability, maintainability, and architecture.
...
- For real-world code examples of each issue, see [examples.md](examples.md)
- For complete Android coding standards and checklists, see [standards.md](standards.md)
