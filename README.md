...
dependencies {
    ...
    implementation("com.github.Rhpark.Simple_UI_XML:Simple_UI_Core:0.3.35")  // Core functionality only
    implementation("com.github.Rhpark.Simple_UI_XML:Simple_UI_XML:0.3.35")   // XML UI components (includes Core)
