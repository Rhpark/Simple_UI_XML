...
class BaseRcvDataBindingViewHolderRobolectricTest {
    ...
    private class TestBindingViewHolder(
    ...
    ) : BaseRcvDataBindingViewHolder<ViewDataBinding>(xmlRes, parent, attachToRoot) {
        ...
        fun hasExecutePendingBindingsMethod(): Boolean {
            ...
            return try {
                ...
                BaseRcvDataBindingViewHolder::class.java.getDeclaredMethod("executePendingBindings")
                true
