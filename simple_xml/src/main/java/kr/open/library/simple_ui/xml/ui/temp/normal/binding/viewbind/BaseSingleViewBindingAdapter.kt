...
/**
 * Single layout ViewBinding RecyclerView.Adapter base.<br><br>
 * ViewBinding 단일 레이아웃 RecyclerView.Adapter 베이스입니다.<br>
 */
...
) : BaseRcvViewBindingAdapterCore<ITEM, BINDING>(diffUtilEnabled, diffExecutor) {
    /**
