...
abstract class ParentBindingViewDialogFragment<BINDING : ViewBinding> :
     ...
     * Use this to share a ViewModel between this DialogFragment and its host Activity.<br><br>
     * 부모 Activity 스코프의 ViewModel을 가져옵니다.<br>
     * 이 DialogFragment와 호스트 Activity 간 ViewModel을 공유할 때 사용하세요.<br>
     *
     * @param T The type of the ViewModel to obtain.<br><br>
     *          가져올 ViewModel 타입.<br>
     ...
     *
     * @throws IllegalStateException If the DialogFragment is not attached to an Activity.<br><br>
     *                               DialogFragment가 Activity에 attach되지 않은 경우 예외가 발생합니다.<br>
     */
