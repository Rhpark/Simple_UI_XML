...
/**
 * A ConstraintLayout that automatically observes the lifecycle of its hosting Activity or Fragment.<br>
 * Implements DefaultLifecycleObserver to receive lifecycle callbacks.<br><br>
 * 호스팅 Activity 또는 Fragment의 생명주기를 자동으로 관찰하는 ConstraintLayout입니다.<br>
 ...
 * Usage example:<br>
 * ```kotlin
 * class CustomConstraintLayout(context: Context) : BaseLifeCycleConstraintLayout(context) {
 ...
 */
class BaseLifeCycleConstraintLayout :
    ConstraintLayout,
