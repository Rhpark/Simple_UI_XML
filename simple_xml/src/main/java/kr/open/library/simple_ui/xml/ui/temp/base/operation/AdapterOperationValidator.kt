...
internal object AdapterOperationValidator {
     ...
     */
    fun validateInsertPosition(position: Int, listSize: Int): ValidationResult = if (position < 0 || position > listSize) {
     ...
     */
    fun validateAccessPosition(position: Int, listSize: Int): ValidationResult = if (position < 0 || position >= listSize) {
     ...
     */
    fun validateRemovePosition(position: Int, listSize: Int): ValidationResult = if (position < 0 || position >= listSize) {
     ...
     */
    fun validateReplacePosition(position: Int, listSize: Int): ValidationResult = if (position < 0 || position >= listSize) {
     ...
     */
    fun validateMovePositions(from: Int, to: Int, listSize: Int): ValidationResult = if (from < 0 ||
        from >= listSize ||
        to < 0 ||
        to >= listSize
    ) {
     ...
     */
    fun <ITEM> validateItemExists(index: Int): ValidationResult = if (index == -1) {
