 ...
 */
public open class SimpleRcvDataBindingAdapter<ITEM : Any, BINDING : ViewDataBinding>(
    @LayoutRes private val layoutRes: Int,
    private val onBind: (BaseRcvDataBindingViewHolder<BINDING>, ITEM, position: Int) -> Unit,
) : BaseRcvAdapter<ITEM, BaseRcvDataBindingViewHolder<BINDING>>() {
    /**
     * Creates a new ViewHolder instance.<br><br>
     * 새로운 ViewHolder 인스턴스를 생성합니다.<br>
     *
     * @return A new BaseRcvDataBindingViewHolder instance.<br><br>
     *         새로운 BaseRcvDataBindingViewHolder 인스턴스.<br>
     */
