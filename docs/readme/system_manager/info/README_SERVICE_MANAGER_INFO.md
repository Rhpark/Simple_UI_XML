...
- Collects system state updates through Flow- and callback-based APIs.
- Reduces repetitive SDK branching, resource lookup, and receiver/emitter setup.
- Encapsulates lifecycle and permission contracts for sensitive features such as location updates.
...
- See [README_PERMISSION.md](../../README_PERMISSION.md) for permission requirements and policies.
