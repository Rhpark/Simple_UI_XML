...
This feature **spans three modules** (이 기능은 **세 모듈**에 걸쳐 있습니다):
...
### **simple_compose** - Lifecycle-aware Event Effects (라이프사이클 인식 이벤트 효과)
- **Package**: `kr.open.library.simple_ui.compose.state.*`
- **Provides**: `CollectVmEvent`, `CollectAsEffect`
