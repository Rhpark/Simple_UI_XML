package kr.open.library.simpleui_xml.temp.viewbinding.activity
...
import kr.open.library.simpleui_xml.temp.viewbinding.adapter.recyclerview.TempSimpleSingleViewBindingAdapter
import kr.open.library.simpleui_xml.temp.viewbinding.adapter.recyclerview.TempSingleViewBindingAdapter
 ...
 */
class TempAdapterRcvSingleActivity :
    ...
    private fun createAdapter(): RecyclerView.Adapter<*> {
        ...
        val enableDiffUtil = binding.swEnableDiffUtil.isChecked
        val useSimpleAdapter = allowSimpleAdapter && binding.swUseSimpleAdapter.isChecked
