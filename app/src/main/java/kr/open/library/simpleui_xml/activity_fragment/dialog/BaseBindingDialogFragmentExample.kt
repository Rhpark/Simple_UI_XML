...
import kr.open.library.simple_ui.xml.ui.dialog.binding.BaseDataBindingDialogFragment
...
class BaseBindingDialogFragmentExample :
    ...
    override fun onInitBind(binding: DialogBaseBindingDialogFragmentBinding) {
