 ...
 */
class TempAdapterListSingleActivity : BaseActivity(R.layout.activity_temp_adapter_example) {
    /**
     ...
     */
    private val screenTitle: String = "List - Single"
    ...
    private fun createAdapter(): RecyclerView.Adapter<*> {
        ...
        val useCustomDiffCallback = swUseCustomDiffCallback.isChecked
