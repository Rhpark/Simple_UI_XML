 ...
 */
class TempAdapterListSingleActivity : TempAdapterExampleBaseActivity() {
    /**
     * Adapter kind for this screen.<br><br>
     * 이 화면에서 사용하는 어댑터 종류입니다.<br>
     */
    override val adapterKind: TempAdapterKind = TempAdapterKind.LIST
     ...
     */
    override val screenTitle: String = "List - Single"
