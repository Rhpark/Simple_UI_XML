...
import kr.open.library.simpleui_xml.temp.multi.normal.adapter.listadapter.TempMultiNormalListAdapter
 ...
 */
class TempAdapterListMultiActivity : BaseActivity(R.layout.activity_temp_adapter_example) {
    /**
    ...
    private fun createAdapter(): RecyclerView.Adapter<*> {
        ...
        return TempMultiNormalListAdapter(
