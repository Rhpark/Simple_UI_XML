...
public object PermissionConstants {
        ...
        buildMap {
            PermissionSpecialType.entries.forEach {
                when (it) {
                    ...
                    PermissionSpecialType.BIND_NOTIFICATION_LISTENER_SERVICE ->
                        put(
                            it.permission,
                            Settings.ACTION_NOTIFICATION_LISTENER_SETTINGS,
                        )
                    PermissionSpecialType.REQUEST_IGNORE_BATTERY_OPTIMIZATIONS ->
                        put(
                            it.permission,
     ...
     */
    val PERMISSIONS_REQUIRING_PACKAGE_URI =
        buildSet<String> {
    ...
    object ApiLevelRequirements {
         ...
         */
        val ANDROID_TIRAMISU_PERMISSIONS =
            buildSet<String> {
