...
class BaseViewModelEventTest {
    ...
    @Test
    fun sendEvent_emitsToFlow() =
        runTest {
            val viewModel =
                object : BaseViewModelEvent<String>() {
    ...
    @Test
    fun multipleEvents_receivedInOrder() =
        runTest {
            val viewModel =
                object : BaseViewModelEvent<String>() {
                    fun sendEventPublic(event: String) = sendEventVm(event)
    ...
    @Test
    fun differentEventTypes_canBeEmitted() =
        runTest {
            // Int 타입 이벤트
            val intViewModel =
                object : BaseViewModelEvent<Int>() {
    ...
    // Custom 데이터 클래스 이벤트
    @Test
    fun customDataClass_canBeEmitted() =
        runTest {
            ...
            val viewModel =
                object : BaseViewModelEvent<CustomEvent>() {
    ...
    @Test
    fun afterCleared_flowCompletesNormally() =
        runTest {
            val viewModel =
                object : BaseViewModelEvent<String>() {
                    fun sendEventPublic(event: String) = sendEventVm(event)
    ...
    @Test
    fun multipleCollectors_onlyFirstCollectorReceivesEvents() =
        runTest {
            val viewModel =
                object : BaseViewModelEvent<String>() {
                    fun sendEventPublic(event: String) = sendEventVm(event)
    ...
    @Test
    fun lifecycleCallbacks_workWithEvents() =
        runTest {
