...
class BaseRcvListAdapterRobolectricTest {
    ...
    fun onViewRecycled_clearsViewCacheForBaseRcvViewHolder() {
        ...
        val testAdapter = object : BaseRcvListAdapter<TestItem, kr.open.library.simple_ui.presenter.ui.adapter.viewholder.BaseRcvViewHolder>(
            RcvListDiffUtilCallBack(
                itemsTheSame = { oldItem, newItem -> oldItem.id == newItem.id },
                contentsTheSame = { oldItem, newItem -> oldItem == newItem }
            )
            ...
            override fun onCreateViewHolder(
                parent: ViewGroup,
                viewType: Int
            ): kr.open.library.simple_ui.presenter.ui.adapter.viewholder.BaseRcvViewHolder {
                return kr.open.library.simple_ui.presenter.ui.adapter.viewholder.BaseRcvViewHolder(
            ...
            override fun onBindViewHolder(
                holder: kr.open.library.simple_ui.presenter.ui.adapter.viewholder.BaseRcvViewHolder,
                position: Int,
                item: TestItem
            ) {
                // No binding needed
