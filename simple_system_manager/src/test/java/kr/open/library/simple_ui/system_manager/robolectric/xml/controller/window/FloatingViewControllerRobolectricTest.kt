package kr.open.library.simple_ui.system_manager.robolectric.xml.controller.window
...
import kr.open.library.simple_ui.system_manager.xml.controller.window.FloatingViewController
...
class FloatingViewControllerRobolectricTest {
    ...
    private fun forcePermissionGranted(controller: FloatingViewController) {
        val requiredPermissionsField = BaseSystemService::class.java
            .getDeclaredField("requiredPermissions")
        requiredPermissionsField.isAccessible = true
        requiredPermissionsField.set(controller, null)

        val remainPermissionsField = BaseSystemService::class.java
            .getDeclaredField("remainPermissions")
