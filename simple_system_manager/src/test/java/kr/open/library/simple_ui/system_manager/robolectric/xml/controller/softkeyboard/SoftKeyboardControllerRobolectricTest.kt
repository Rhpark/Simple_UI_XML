package kr.open.library.simple_ui.system_manager.robolectric.xml.controller.softkeyboard
...
import kr.open.library.simple_ui.system_manager.xml.controller.softkeyboard.SoftKeyboardFailureReason
...
class SoftKeyboardControllerRobolectricTest {
    ...
    fun `show returns false when called off main thread`() {
        ...
        val result = AtomicReference<SystemResult<Unit>?>(null)
        ...
        assertFailure(requireNotNull(result.get()))
    }
