package kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte
...
public data class CellInfoLteData(
    ...
    private var cellDataLteIdentity =
        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte.CellIdentityLteData(
            cellInfo?.cellIdentity
        )
    private var cellDataLteSignalStrength =
        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte.CellSignalStrengthLteData(
