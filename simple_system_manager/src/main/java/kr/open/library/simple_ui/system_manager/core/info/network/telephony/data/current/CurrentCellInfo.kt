package kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.current
...
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma.CellInfoCdmaData
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.gsm.CellInfoGsmData
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte.CellInfoLteData
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.nr.CellInfoNrData
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.tdscdma.CellInfoTdscdmaData
import kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.wcdma.CellInfoWcdmaData
...
public data class CurrentCellInfo(
    ...
    public val cellDataCdmaList:
        MutableList<kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma.CellInfoCdmaData> = mutableListOf()
    ...
    public val cellDataLteList:
        MutableList<kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte.CellInfoLteData> = mutableListOf()
    ...
    init {
        cellInfo.forEach { item ->
            when (item) {
                is CellInfoLte -> {
                    cellDataLteList.add(
                        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.lte.CellInfoLteData(
                            item
                        )
                    )
                }
                ...
                is CellInfoCdma -> {
                    cellDataCdmaList.add(
                        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma.CellInfoCdmaData(
                            item
                        )
                    )
                }
