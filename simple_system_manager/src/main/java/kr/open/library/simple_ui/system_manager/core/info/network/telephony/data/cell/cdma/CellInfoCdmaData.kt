package kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma
...
public data class CellInfoCdmaData(
    ...
    private var cellDataCdmaIdentity =
        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma.CellIdentityCdmaData(
            cellInfo?.cellIdentity
        )
    private var cellDataCdmaSignalStrength =
        kr.open.library.simple_ui.system_manager.core.info.network.telephony.data.cell.cdma.CellSignalStrengthCdmaData(
